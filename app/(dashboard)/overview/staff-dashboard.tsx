    ...
    <div className="space-y-6 max-w-screen-xl">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Teaching tools, assigned courses, and attendance workflows will be
          completed here.
        </p>
      </div>
          ...
          <Card key={stat.label}>
            <CardContent className="p-5">
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Pending staff API/view integration
              </p>
            </CardContent>
          </Card>
        ))}
      ...
      <Card>
        ...
        <CardContent className="text-sm text-muted-foreground">
          Staff navigation is separated now. We can later replace this
          placeholder with assigned course queries, active sessions, and quick
          attendance actions.
        </CardContent>
      </Card>
    </div>
